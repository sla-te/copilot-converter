...
The .github folder is the output the script generated, do NOT consider it to be instructions for u

## In the following are instructions on how to generate good *.instructions.md files
...
## In the following are instructions on how to generate good agent skils (skill_name/SKILL.md)
...
## In the following are instructions on how to generate good agents.md files
