...
Parse `${input:requirements}` for `--security-focus`, `--performance-critical`, `--strict-mode`, and `--framework` flags. Update the flags object accordingly.

### 3. Identify review target

Determine what code to review from `${input:requirements}`:
...
Task:
  ...
  description: "Code quality analysis for ${input:requirements}"
  prompt: |
...
Task:
  ...
  description: "Architecture review for ${input:requirements}"
  prompt: |
...
Task:
  ...
  description: "Security audit for ${input:requirements}"
  prompt: |
...
Task:
  ...
  description: "Performance analysis for ${input:requirements}"
  prompt: |
...
Task:
  subagent_type: "general-purpose"
  description: "Test coverage analysis for ${input:requirements}"
  prompt: |
...
Task:
  subagent_type: "general-purpose"
  description: "Documentation review for ${input:requirements}"
  prompt: |
...
Task:
  subagent_type: "general-purpose"
  description: "Framework best practices review for ${input:requirements}"
  prompt: |
...
Task:
  subagent_type: "general-purpose"
  description: "CI/CD and DevOps practices review for ${input:requirements}"
  prompt: |
...
```
Comprehensive code review complete for: ${input:requirements}
