---
name: "suggest-copilot-converter-collections"
agent: "agent"
description: "Suggest relevant plugin collections from this repository marketplace (translated from Claude plugins)."
---

# Suggest Marketplace Plugin Collections
...
2. Scan `plugins/*` and extract names and descriptions.
3. Analyze current repository context and recent chat goals.
4. Compare against existing local assets in installed plugins and local workspace capabilities to avoid duplicates.
